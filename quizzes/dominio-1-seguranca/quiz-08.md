# Mini-quiz 08 — Domínio 1 — Projetar arquiteturas seguras
...
## 1. Permissions boundaries e delegação
...
## 3. S3 privado atrás do CloudFront
...
## 5. Rotação de credenciais com Secrets Manager
